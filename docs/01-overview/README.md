...
* 需要理解知识引擎如何解决"多源异构→统一知识表示"等 8 个核心问题的决策者
...
1. [`01-vision.md`](./01-vision.md) — 愿景 + 8 个核心问题 + 五层架构 + 7 大参考系统 + **6 大关键操作旅程**
...
| 文档                          | 主要回答的问题                                     | 使用边界                             |
| --------------------------- | ------------------------------------------- | -------------------------------- |
| `01-vision.md`              | 为什么做、做什么，8 个核心问题 + 五层架构 + 7 大参考系统 + 6 大操作旅程 | 不承载实施细节                          |
...
本次重构将文档体系**严格分离目标态与当前态**，整合了 7 个参考系统的最新设计，并新增基于 DeepResearchAgent 调研的**五层系统架构**和**8 个核心问题定义**。
...
3. **`01-vision.md`**：移除"已实现"表达，整合 7 大参考系统的关键设计点，新增五层系统架构和 8 个核心问题定义
