...
| 平台化能力 | 当前约束仍以本地优先为主 | 目标态引入空间、同步、管理面 | [`05-schema-v2/06-dataset-and-sync.md`](../05-schema-v2/06-dataset-and-sync.md)、[`10-api-architecture.md`](../10-api-architecture.md) | **[待扩展]** | 用 `current / optional / future` 三栏归位，避免混写 |
